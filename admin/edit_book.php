...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<span><marquee>Library opens at 8:00 AM and close at 5:00 PM</marquee></span><br><br>
...
<?php
	if(isset($_POST['update'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"lms");
		$query = "update books set book_name = '$_POST[book_name]',cat_id = $_POST[cat_id],book_price = $_POST[book_price] where book_no = $_GET[bn]";
		$query_run = mysqli_query($connection,$query);
